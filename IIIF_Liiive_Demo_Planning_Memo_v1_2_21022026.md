...
| v1.2 | 2026-02-21 | Claude Opus 4.6/Colin | Corrected liiive GitHub URL from rainersimon/liiive to rsimon/liiive; removed Section 9 (Relationship to Project Portfolio) |
...
Liiive ([https://github.com/rsimon/liiive](https://github.com/rsimon/liiive)) is an open-source, browser-based tool for real-time collaborative annotation of IIIF images. Key capabilities include:
...
"liiive: Collaborative Annotation for IIIF Images." GitHub, [https://github.com/rsimon/liiive](https://github.com/rsimon/liiive). Accessed 21 Feb. 2026.
